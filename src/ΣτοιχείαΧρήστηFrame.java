...
public class Óôïé÷åßá×ñŞóôçFrame {
	...
	private Secretary user; //×ÑÇÓÔÇÓ ĞÏÕ ÂËÅĞÅÉ ÔÏ ÖÑÅÉÌ.(Ï×É ÁÕÔÏÓ ÓÔÏÍ ÏĞÏÉÏ ÁÍÇÊÅÉ)
	
	/*
	 * ÓÅ ÁÕÔÏ ÔÏ ÖÑÅÉÌ ÅÌÖÁÍÉÆÏÍÔÁÉ ÔÁ ÓÔÏÉ×ÅÉÁ ÅÍÏÓ
	 * ×ÑÇÓÔÇ ÔÏÕ ÓÕÓÔÇÌÁÔÏÓ.(ÃÉÁÔÑÏÕ Ç ÍÏÓÇËÅÕÔÇ).
	 */

	public Óôïé÷åßá×ñŞóôçFrame(String username,Secretary user) {
	...
	//ÌÅ×ÑÉ ÔÇ ÃÑÁÌÌÇ 268 ÃÉÍÅÔÁÉ Ç ÔÏĞÏÈÅÔÉÓÇ ĞÅÄÉÙÍ ÓÔÏ ÖÑÅÉÌ.
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 698, 581);
		frame.getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("¼íïìá ÷ñŞóôç");
		lblNewLabel.setBounds(51, 23, 80, 22);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel label = new JLabel("¼íïìá");
		label.setBounds(51, 56, 80, 22);
		frame.getContentPane().add(label);
		
		JLabel label_1 = new JLabel("Åğşíõìï");
		label_1.setBounds(51, 89, 94, 14);
		frame.getContentPane().add(label_1);
		
		JLabel label_2 = new JLabel("Åéäçêüôçôá");
		label_2.setBounds(51, 295, 94, 14);
		frame.getContentPane().add(label_2);
		
		JLabel label_3 = new JLabel("Äéåıèõíóç");
		label_3.setBounds(51, 200, 86, 14);
		frame.getContentPane().add(label_3);
		
		JLabel label_4 = new JLabel("Ğåñéï÷Ş");
		label_4.setBounds(51, 153, 80, 29);
		frame.getContentPane().add(label_4);
		
		JLabel label_5 = new JLabel("Êéíçôü Ôçëİöùíï");
		label_5.setBounds(51, 259, 94, 14);
		frame.getContentPane().add(label_5);
		
		JLabel label_6 = new JLabel("Ôçëİöùíï ïéêßáò");
		label_6.setBounds(375, 23, 99, 14);
		frame.getContentPane().add(label_6);
		
		JLabel label_7 = new JLabel("Ğáôñşíõìï");
		label_7.setBounds(375, 59, 99, 14);
		frame.getContentPane().add(label_7);
		
		JLabel label_8 = new JLabel("Çìåñïìçíßá Ãİííçóçò");
		label_8.setBounds(375, 96, 127, 14);
		frame.getContentPane().add(label_8);
		
		JLabel label_9 = new JLabel("ÊëéíéêŞ");
		label_9.setBounds(375, 143, 46, 14);
		frame.getContentPane().add(label_9);
		
		JLabel label_10 = new JLabel("Ğüëç");
		...
		JLabel lblNewLabel_2 = new JLabel("ĞáñáôçñŞóåéò");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frame.dispose();  		//ÌÅ ÏÊ ÃÕÑÍÁÌÅ ĞÉÓÙ ÓÔÏ ÓÔÇÍ ÁÍÁÆÇÔÇÓÇ ÃÉÁÔÑÙÍ
		...
		JButton btnNewButton_1 = new JButton("ĞñïóèŞêç/ÁëëáãŞ êëéíéêŞò"); //ÁÍ ĞÁÔÇÈÅÉ ÁÕÔÏ ÔÏ ÊÏÕÌĞÉ 
		btnNewButton_1.addActionListener(new ActionListener() {				//ÃÉÍÅÔÁÉ ÁËËÁÃÇ ÓÔÇÍ ÊËÉÍÉÊÇ ÔÏÕ ÓÕÃÊÅÊÑÉÌÅÍÏÕ ×ÑÇÓÔÇ
			public void actionPerformed(ActionEvent e) {
				frame.dispose();
		...
		if(	User.loadUser(username).isGiatros()) //ÅÌÖÁÍÉÆÅÔÁÉ ÓÅ ÁÕÔÏ ÔÏ ĞÅÄÉÏ Ï ÔÕĞÏÓ ÔÏÕ ×ÑÇÓÔÇ 
			textField.setText("Ãéáôñüò");
		else
			textField.setText("ÍïóçëåõôŞò");
		
		textField.setBounds(546, 335, 114, 20);
		frame.getContentPane().add(textField);
		textField.setColumns(10);
		
		try{	//ÓÕÌĞËÇÑÙÓÇ ĞÅÄÉÙÍ ÖÑÅÉÌ.
			...
			while(result.next()){ 
				...
				if (fyllo.equals("M"))
					genderField.setText("¢íôñáò");
				else if(fyllo.equals("F"))
					genderField.setText("Ãõíáßêá");
				else
					genderField.setText("");
